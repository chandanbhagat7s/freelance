...
exports.submitFreeForm = exports.submitAssignForm = exports.loginFormIn = void 0;
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } // for support to old browsers 
var loginFormIn = exports.loginFormIn = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return _axios.default.post("http://127.0.0.1:3004/api/v1/users/login", _objectSpread({}, data));
        case 4:
          res = _context.sent;
          console.log(res);
          if (res.data.status == 'success') {
            (0, _alerts.alertt)("success", "logged in successfully ");
          }
          _context.next = 13;
          break;
        case 9:
          _context.next = 11;
          return _axios.default.post("http://127.0.0.1:3004/api/v1/assign/login", _objectSpread({}, data));
        case 11:
          res = _context.sent;
          if (res.data.status == 'success') {
            (0, _alerts.alertt)("success", "logged in successfully ");
        ...
        case 16:
          ...
          (0, _alerts.alertt)("danger", _context.t0.response.data.massage);
        case 20:
        case "end":
  ...
  return function loginFormIn(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var submitAssignForm = exports.submitAssignForm = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return _context2.abrupt("return", (0, _alerts.alertt)("danger", "please enter password and confirm password correctly"));
        case 3:
          _context2.next = 5;
          return _axios.default.post("http://127.0.0.1:3004/api/v1/assign/signup", _objectSpread({}, data));
        case 5:
          res = _context2.sent;
          console.log(res);
          _context2.next = 12;
        ...
        case 9:
          ...
          (0, _alerts.alertt)("danger", _context2.t0.response.data.massage);
        case 12:
        case "end":
  ...
  return function submitAssignForm(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var submitFreeForm = exports.submitFreeForm = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return _context3.abrupt("return", (0, _alerts.alertt)("danger", "please enter password and confirm password correctly"));
        case 3:
          _context3.next = 5;
        ...
        case 9:
          ...
          (0, _alerts.alertt)("danger", "something went wrong please try again to signup");
        case 12:
        case "end":
  ...
  return function submitFreeForm(_x5) {
...
var _require = require("./functions"),
  submitAssignForm = _require.submitAssignForm,
  submitFreeForm = _require.submitFreeForm,
  loginFormIn = _require.loginFormIn;
var freelancerFormBtn = document.getElementById("freelancerFormBtn");
var projectAssignFormBtn = document.getElementById("projectAssignFormBtn");
